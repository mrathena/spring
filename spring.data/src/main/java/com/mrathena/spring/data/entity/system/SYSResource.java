...
public class SYSResource {
	...
	public String toString() {
		return "SYSResource [id=" + id + ", type=" + type + ", name=" + name + ", ico=" + ico + ", url=" + url + ", priority=" + priority + ", permission=" + permission + ", description=" + description + ", parentId=" + parentId + ", available=" + available + "]";
	}
