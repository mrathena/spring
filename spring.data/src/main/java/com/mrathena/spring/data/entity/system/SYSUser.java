package com.mrathena.spring.data.entity.system;
...
public class SYSUser {
	...
	public String toString() {
		return "SYSUser [id=" + id + ", username=" + username + ", password=" + password + ", salt=" + salt + ", roleIds=" + roleIds + ", includeIds=" + includeIds + ", excludeIds=" + excludeIds + ", createTime=" + createTime + ", available=" + available + "]";
	}
